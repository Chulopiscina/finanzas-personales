...
const categoryRules: Array<[string, RegExp]> = [
  ...
  [CATEGORY_NAMES.shopping, /\b(amazon|zara|mango|uniqlo|womens|women\'?s|nikepos_es|nikepos[_a-z0-9]*|nike|el corte ingl[e\u00e9]s|media markt|ikea|decathlon|tienda|compras digitales|steam|lovable)\b/i],
  ...
  [CATEGORY_NAMES.leisure, /\b(cine|teatro|concierto|entradas|ocio|winamax|steam|playstation|xbox|atrapalo)\b/i],
