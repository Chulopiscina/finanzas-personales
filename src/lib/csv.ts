...
const categoryRules: Array<[string, RegExp]> = [
  ...
  [CATEGORY_NAMES.restaurants, /\b(restaurante|restaurantes y cafeterias|restaurantes y cafeter[i\u00ed]as|rest\b|bar |cafeter[i\u00ed]a|burger|pizza|glovo|uber eats|deliveroo|just eat)\b/i],
  [CATEGORY_NAMES.supermarket, /\b(mercadona|carrefour|lidl|aldi|bonpreu|caprabo|supermercado|supermercados|consum|alcampo|dia market)\b/i],
  [CATEGORY_NAMES.transport, /\b(tmb|renfe|metro|bus|taxi|uber|cabify|transport|transporte|parking|peaje)\b/i],
  [CATEGORY_NAMES.fuel, /\b(gasolinera|gasolineras|repsol|cepsa|bp |shell|galp|diesel|carburante)\b/i],
  [CATEGORY_NAMES.health, /\b(farmacia|medicina|medicina farmacia y sanidad|sanidad|cl[i\u00ed]nica|hospital|dentista|seguro salud|mutua)\b/i],
  [CATEGORY_NAMES.shopping, /\b(amazon|zara|mango|uniqlo|el corte ingl[e\u00e9]s|media markt|ikea|decathlon|tienda|compras digitales|steam|lovable)\b/i],
  [CATEGORY_NAMES.subscriptions, /\b(netflix|spotify|hbo|disney|apple\.com\/bill|apple|google|prime|suscripci[o\u00f3]n|adobe|notion|steam|lovable)\b/i],
